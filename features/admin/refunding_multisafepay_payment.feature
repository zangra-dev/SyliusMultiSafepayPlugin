@refunding_multisafepay_payment
Feature: Refunding order's MultiSafepay payment
    ...
    Background:
        ...
        And the customer chose "Free" shipping method to "United States" with "MultiSafepay" payment
        And this order with multisafepay payment is already paid
